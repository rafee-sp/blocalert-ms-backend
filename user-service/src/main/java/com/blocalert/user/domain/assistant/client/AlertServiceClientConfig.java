...
@Configuration
public class AlertServiceClientConfig {

    @Bean
    AlertServiceClient alertServiceClient(RestClient.Builder builder,
                                        OAuth2AuthorizedClientManager auth2AuthorizedClientManager,
                                        @Value("${services.alert-service.base-url}") String baseUrl) {
        ...
        return factory.createClient(AlertServiceClient.class);
    }
}
